...
import { PAYMENT_TYPES, LEVELS, PAYMENT_MODES, GOOGLE_SCRIPT_URL } from '../constants';
import { Send, Loader2, CheckCircle2, AlertCircle, Fingerprint, MessageSquare, Wallet, Target } from 'lucide-react';
...
const PaymentForm: React.FC<PaymentFormProps> = ({ userCedula }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <form onSubmit={handleSubmit} className="bg-white border rounded-2xl p-6 md:p-8 shadow-sm space-y-8">
        {/* Selector de Modo de Pago (Total vs Abono) */}
        <div className="space-y-3">
          <label className="block text-sm font-bold text-slate-700 uppercase tracking-wider text-[11px]">Tipo de Operación *</label>
          <div className="grid grid-cols-2 gap-4">
            {PAYMENT_MODES.map((modo) => (
              <button
                ...
                `}
              >
                {modo === 'Pago Total' ? <Target size={20} /> : <Wallet size={20} />}
                <span className="font-bold text-sm">{modo}</span>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <input 
              type="text" name="cedula" readOnly value={formData.cedula}
          ...
          <div className="space-y-2">
            ...
            <input 
              type="date" name="fechaPago" required value={formData.fechaPago} onChange={handleChange}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                type="text" name="matricula" placeholder="Ej: MBPF-2025-001" value={formData.matricula} onChange={handleChange} 
          ...
          <div className="space-y-2">
            ...
            <select 
              name="tipoPago" value={formData.tipoPago} onChange={handleChange} 
              className="w-full border border-slate-200 rounded-lg px-4 py-2.5 outline-none bg-white focus:ring-2 focus:ring-blue-500 transition-all"
            >
          ...
          <div className="space-y-2">
            ...
            <input 
              type="text" name="referencia" required placeholder="Nro de comprobante" value={formData.referencia} onChange={handleChange} 
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                type="number" name="monto" step="0.01" required placeholder="0.00" value={formData.monto} onChange={handleChange} 
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <div className="relative">
              ...
              <textarea 
                name="observaciones" rows={2} placeholder="Indique el mes que está cancelando o cualquier detalle..." 
